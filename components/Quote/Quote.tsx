    ...
    <>
      <div className={styles["quote-wrapper"]}>
        ...
        <div className={styles["quote"]}>
          ...
          wheat because it&apos;s dry and can&apos;t bend with the wind. But
          ripe buckwheat&apos;s got sap in it and it bends. And when the wind
          has passed, it springs up almost as straight and strong as before. We
          aren&apos;t a stiff-necked tribe. We&apos;re mighty limber when a hard
          wind&apos;s blowing, because we know it pays to be limber. When
          trouble comes we bow to the inevitable without any mouthing, and we
          work and we smile and we bide our time... That, my child, is the
